...
// 아이콘 이미지
import logo from "../../assets/img/manSvg.svg";
      ...
      <StWrap>
        <StModalContainer>
          <StContentWrap>
            ...
            <br />
            <br />
            ['투두투두']은(는) 「개인정보 보호법」 제30조에 따라 정보주체의
            ...
            <br />
            <br />
            ['https://www.todotodo.com/' 이하 '투두투두']은(는) 다음의 목적을
            위하여 개인정보를 처리합니다.
            <br />
            ...
            <br />
            ① ( 투두투두 )은(는) 법령에 따른 개인정보 보유·이용기간 또는
            ...
            <br />
            ① ( 투두투두 )은(는) 다음의 개인정보 항목을 처리하고 있습니다.
            <br />
            <br />
            1. 홈페이지 회원가입 및 관리 <br />
            필수항목 : 이메일, 비밀번호, 이름, 학력, 서비스 이용 기록, 접속
            로그, 쿠키
            <br />
            선택항목 : 없음
            <br />
            ...
            <br />
            ① ( 투두투두 ) 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
            ...
            1. 파기절차
            <br />
            [ 투두투두 ] 은(는) 파기 사유가 발생한 개인정보를 선정하고, [
            투두투두 ] 의 개인정보 보호책임자의 승인을 받아 개인정보를
            파기합니다.
            <br />
            <br />
            2. 파기방법
            ...
            <br />
            ① 정보주체는 투두투두에 대해 언제든지 개인정보
            열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
            <br />
            <br />
            ② 제1항에 따른 권리 행사는투두투두에 대해 「개인정보 보호법」 시행령
            제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
            있으며 투두투두은(는) 이에 대해 지체 없이 조치하겠습니다.
            <br />
            <br />
            ...
            <br />
            <br />
            ⑥ 투두투두은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
            ...
            <br />
            [ 투두투두 ]은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를
            취하고 있습니다.
            <br />
            <br />
            1. 내부관리계획의 수립 및 시행
            ...
            <br />
            ① 투두투두 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
            ...
            <br />
            ① 투두투두 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
            ...
            <br />
            <br />
            ② 정보주체께서는 투두투두 의 서비스(또는 사업)을 이용하시면서 발생한
            모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
            개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다.
            <br />
            <br />
            투두투두 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴
            것입니다.
            <br />
            <br />
            <StTitle>제9조</StTitle>
            ...
            아래의 부서에 할 수 있습니다.
            <br />
            [ 투두투두 ]은(는) 정보주체의 개인정보 열람청구가 신속하게
            처리되도록 노력하겠습니다.
            <br />
            <br />
            ▶ 개인정보 열람청구 접수·처리 부서
            ...
            <br />① 이 개인정보처리방침은 2022년 10월 1부터 적용됩니다.
          </StContentWrap>
        </StModalContainer>
